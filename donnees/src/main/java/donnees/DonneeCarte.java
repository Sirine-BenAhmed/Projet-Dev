...
public class DonneeCarte {
    ...
    public DonneeCarte(){
        ...
        mesCartes.add(carte4);
        mesCartes.add(carte5);
        mesCartes.add(carte6);
        mesCartes.add(carte7);
        mesCartes.add(carte8);
        mesCartes.add(carte9);
        mesCartes.add(carte10);
        mesCartes.add(carte11);
        mesCartes.add(carte12);
        mesCartes.add(carte13);
        mesCartes.add(carte14);
        mesCartes.add(carte15);
        mesCartes.add(carte16);
        mesCartes.add(carte17);
        mesCartes.add(carte18);
        mesCartes.add(carte19);
        mesCartes.add(carte20);
        mesCartes.add(carte21);
        mesCartes.add(carte22);
        mesCartes.add(carte23);
        mesCartes.add(carte24);
        mesCartes.add(carte25);
        mesCartes.add(carte26);
        mesCartes.add(carte27);
        mesCartes.add(carte28);
        mesCartes.add(carte29);
        mesCartes.add(carte30);
        mesCartes.add(carte31);
        mesCartes.add(carte32);
        mesCartes.add(carte33);
        mesCartes.add(carte34);
        mesCartes.add(carte35);
        mesCartes.add(carte36);
        mesCartes.add(carte37);
        mesCartes.add(carte38);
        mesCartes.add(carte39);
        mesCartes.add(carte40);
        mesCartes.add(carte41);
        mesCartes.add(carte42);
        mesCartes.add(carte43);
        mesCartes.add(carte44);
        mesCartes.add(carte45);
        mesCartes.add(carte46);
        mesCartes.add(carte47);
